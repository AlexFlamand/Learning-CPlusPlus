...
// The purpose of this program is to determine the deflection of a beam of given dimensions supplied with thats end is affixed with a weight at half-foot increments. 
...
int main()
{
	...
	cout << " CANTILEVER BEAM CALCULATOR" << endl;											// FORMATTING OF TITLE AND PARAMETERS
	cout << "" << endl;
	cout << "For a beam of 3.0 x 0.2 x 0.3 ft. "
		 << "with a weight of 200 " << endl;
	cout << "lbs. and an elastic modulus of 1.872 x 10^8 lbs/sqr(ft)." << endl; 
	cout << "" << endl;
	cout << setw(7) << "  Length: "
